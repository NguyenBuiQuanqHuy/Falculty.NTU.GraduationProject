...
- Chức năng duyệt đề tài: cho phép Trưởng khoa xem và lọc danh sách các đề tài đang chờ duyệt theo năm học, lĩnh vực, thể loại và tên giảng viên. 
![image](https://github.com/user-attachments/assets/7b108cf3-9f0c-4bc6-b19b-fb972a4809de)

- Chức năng cấp tài khoản và quản lý tài khoản: cho phép Trưởng khoa tạo tài khoản mới cho sinh viên hoặc giảng viên bằng cách nhập mã số, họ tên, email và vai trò cũng như quản lý tài khoản
...
- Chức năng tạo đề tài: cho phép giảng viên tạo đề tài mới trong hệ thống
![image](https://github.com/user-attachments/assets/0882f9df-2dce-4322-b423-b3bb4d29fc3f)

- Chức năng duyệt sinh viên đăng ký đề tài: cho phép giảng viên đăng nhập xem danh sách sinh viên đã đăng ký một đề tài cụ thể, sau đó thực hiện duyệt sinh viên nếu số lượng sinh viên đã duyệt chưa vượt quá giới hạn tối đa của đề tài và hạn mức hướng dẫn của giảng viên theo loại đề tài (Đồ án hoặc Chuyên đề)
...
- Chức năng hiển thị danh sách đề tài của giảng viên: cho phép giảng viên xem danh sách đề tài đã được duyệt trong hệ thống, kèm theo các bộ lọc theo tên đề tài, năm học, thể loại và lĩnh vực. 
![image](https://github.com/user-attachments/assets/f7debe3c-8b94-4c19-b41e-e9f964609511)

- Chức năng đánh giá đề tài: cho phép giảng viên đánh giá quá trình mà sinh viên thực hiện đề tài
...
- Chức năng đăng ký đề tài: Trang web hiển thị danh sách các đề tài đã được Khoa duyệt để sinh viên có thể lựa chọn đăng ký
...
- Chức năng xem đánh giá đề tài: Sinh viên sẽ được xem đánh giá của giảng viên ở các đề tài trước đó
![image](https://github.com/user-attachments/assets/2ce54924-e71c-468e-beae-b8119c54256c)

# Các chức năng khác:
- Chức năng chỉnh sửa hồ sơ: sinh viên và giảng viên sẽ được chỉnh sửa hồ sơ cá nhân của mình
<img width="942" height="448" alt="image" src="https://github.com/user-attachments/assets/bedb3785-d913-4850-bf69-f5be21bbc866" />

- Chức năng xem nội dung đề tài bằng pdf
