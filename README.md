...
# - Chức năng duyệt đề tài: cho phép Trưởng khoa xem và lọc danh sách các đề tài đang chờ
duyệt theo năm học, lĩnh vực, thể loại và tên giảng viên. 
![image](https://github.com/user-attachments/assets/7b108cf3-9f0c-4bc6-b19b-fb972a4809de)

# - Chức năng cấp tài khoản và quản lý tài khoản: cho phép Trưởng khoa tạo tài khoản mới cho sinh viên 
# hoặc giảng viên bằng cách nhập mã số, họ tên, email và vai trò cũng như quản lý tài khoản
...
# - Chức năng duyệt sinh viên đăng ký đề tài: cho phép giảng viên
# đăng nhập xem danh sách sinh viên đã đăng ký một đề tài cụ thể, sau đó thực hiện
# duyệt sinh viên nếu số lượng sinh viên đã duyệt chưa vượt quá giới hạn tối đa của đề
# tài và hạn mức hướng dẫn của giảng viên theo loại đề tài (Đồ án hoặc Chuyên đề)
...
# - Chức năng hiển thị danh sách đề tài của giảng viên: cho phép giảng viên xem danh sách đề tài đã được duyệt trong hệ
# thống, kèm theo các bộ lọc theo tên đề tài, năm học, thể loại và lĩnh vực. 
...
# - Chức năng đăng ký đề tài: Trang web hiển thị danh sách các đề tài đã được Khoa duyệt để sinh viên có thể lựa
# chọn đăng ký
